...
namespace AppleReceiptVerifier.Test
{
    ...
    public class ReceiptManagerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpRequestReturnsException_Response_StatusShouldBe1()
        {
            this.appleHttpRequestMock.Setup(x => x.GetResponseAsync(It.IsAny<Uri>(), It.IsAny<string>())).Throws(new Exception());
            var response = await this.receiptManager.ValidateReceiptAsync(new Uri("http://www.test.com"), string.Empty);
            Assert.AreEqual(1, response.Status);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpRequestReturnsEmptyResult_Response_StatusShouldBe1()
        {
            this.appleHttpRequestMock.Setup(x => x.GetResponseAsync(It.IsAny<Uri>(), It.IsAny<string>())).Returns(Task.FromResult(string.Empty));
            var response = await this.receiptManager.ValidateReceiptAsync(new Uri("http://www.test.com"), string.Empty);
            Assert.AreEqual(1, response.Status);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpRequestReturnsMalformedResult_Response_StatusShouldBe1()
        {
            this.appleHttpRequestMock.Setup(x => x.GetResponseAsync(It.IsAny<Uri>(), It.IsAny<string>())).Returns(Task.FromResult("asdjlaksdjlkasjdlkajsdlksjd"));
            var response = await this.receiptManager.ValidateReceiptAsync(new Uri("http://www.test.com"), string.Empty);
            Assert.AreEqual(1, response.Status);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_Response_StatusShouldBe0()
        {
            await this.ValidatePropertyAsync<int>(0, x => x.Status);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_Response_RawResponse_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>(this.validResponse, x => x.RawResponse);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttoResponseValid_ResponseReceipt_UniqueIdentifier_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testUniqueIdentifier", x => x.Receipt.UniqueIdentifier);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_UniqueVendorIdentifier_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testUniqueVendorIdentifier", x => x.Receipt.UniqueVendorIdentifier);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_ItemId_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testItemId", x => x.Receipt.ItemId);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_Quantity_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<int>(1, x => x.Receipt.Quantity);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_ProductId_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testProductId", x => x.Receipt.ProductId);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_LatestReceipt_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("base64string", x => x.LatestReceipt);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_TransactionId_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testTransactionId", x => x.Receipt.TransactionId);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_OriginalTransactionId_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testOriginalTransactionId", x => x.Receipt.OriginalTransactionId);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_AppItemId_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testAppItemId", x => x.Receipt.AppItemId);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_VersionExternalIdentifier_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testVersionExternalIdentifier", x => x.Receipt.VersionExternalIdentifier);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_BundleIdentifier_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testBundleIdentifier", x => x.Receipt.BundleIdentifier);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_ApplicationVersionNumber_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<string>("testApplicationVersionNumber", x => x.Receipt.ApplicationVersionNumber);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_PurchaseDateUtc_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<DateTime>(new DateTime(2013, 1, 1), x => x.Receipt.PurchaseDateUtc);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_PurchaseDatePst_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<DateTime>(new DateTime(2013, 1, 1), x => x.Receipt.PurchaseDatePst);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_PurchaseDateMilliseconds_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<long>(123456789, x => x.Receipt.PurchaseDateMilliseconds);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_CancellationDateUtc_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<DateTime>(new DateTime(2014, 1, 1), x => x.Receipt.CancellationDateUtc);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_OriginalPurchaseDateUtc_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<DateTime>(new DateTime(2013, 1, 1), x => x.Receipt.OriginalPurchaseDateUtc);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_OriginalPurchaseDatePst_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<DateTime>(new DateTime(2013, 1, 1), x => x.Receipt.OriginalPurchaseDatePst);
        }
        ...
        /// </summary>
        [TestMethod]
        public async Task ValidateReceiptAsync_HttpResponseValid_ResponseReceipt_OriginalPurchaseDateMilliseconds_ShouldBeValid()
        {
            await this.ValidatePropertyAsync<long>(123456789, x => x.Receipt.PurchaseDateMilliseconds);
        }
        ...
        /// <param name="expected">Expected value</param>
        /// <param name="actualFunc">Actual FUNC to invoke</param>
        private async Task ValidatePropertyAsync<TType>(TType expected, Func<Response, TType> actualFunc)
        {
            this.appleHttpRequestMock.Setup(x => x.GetResponseAsync(It.IsAny<Uri>(), It.IsAny<string>())).Returns(Task.FromResult(this.validResponse));
            var response = await this.receiptManager.ValidateReceiptAsync(new Uri("http://www.test.com"), string.Empty);
            Assert.AreEqual(expected, actualFunc.Invoke(response));
        }
